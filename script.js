const items = [
    ...
    {ratingRevievs: "527 отзывов", price: "3 999 грн", name: "Huawei Y6 Pro Gold + чехол + защитное стекло!"}, {ratingRevievs: "66 отзывов", price: "16 499 грн", name: "Apple iPhone 6s 32GB Gold"}, 
    ...
    {ratingRevievs: "376 отзывов", price: "3 899 грн", name: "Meizu M3 Note 32GB Grey (Международная версия)"}, {ratingRevievs: "111 отзывов", price: {oldUan: "9 999 грн", newUan: "7 999 грн"}, name: "Sony Xperia X Dual (F5122) White"}, 
    ...
    function sortByFeedBacks (arr) {
        ...
        temp.forEach(item => {
            document.querySelector('.result').innerHTML += `
                <h3>${item.name}</h3>
                <div>Price: ${item.price} UAN</div>
                <div>Count of comments: ${item.ratingRevievs}</div>
            `;
        });
